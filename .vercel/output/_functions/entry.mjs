...
import { $ as appSymbol, B as setOriginPathname, E as generateCspDigest, F as RedirectSinglePageBuiltModule, G as NOOP_MIDDLEWARE_FN, H as isRoute500, I as sequence, J as readBodyWithLimit, L as copyRequest, P as getRouteGenerator, Q as REROUTABLE_STATUS_CODES, R as findRouteToRewrite, T as decodeKey, U as MultiLevelEncodingError, V as isRoute404, W as validateAndDecodePathname, X as ASTRO_GENERATOR, Y as ASTRO_ERROR_HEADER, Z as REDIRECT_STATUS_CODES, a as createConsoleLogger, at as shouldAppendForwardSlash, c as getParams, ct as collapseDuplicateSlashes, d as getFallbackRoute, dt as hasFileExtension, et as clientAddressSymbol, f as routeHasHtmlExtension, ft as isInternalPath, g as getPattern, gt as removeLeadingForwardSlash, h as SERVER_ISLAND_COMPONENT, ht as prependForwardSlash, i as PipelineFeatures, it as responseSentSymbol$1, j as renderEndpoint, l as getProps, lt as collapseDuplicateTrailingSlashes, m as routeIsRedirect, mt as joinPaths, n as ALL_PIPELINE_FEATURES, nt as originPathnameSymbol, o as AstroIntegrationLogger, ot as appendForwardSlash, p as routeIsFallback, q as BodySizeLimitError, r as Pipeline, rt as pipelineSymbol, s as routeComparator, st as collapseDuplicateLeadingSlashes, t as Slots, tt as fetchStateSymbol, u as getCustom404Route, ut as fileExtension, vt as removeTrailingForwardSlash, x as renderPage, yt as slash, z as getOriginPathname } from "./chunks/render_DItgDmG4.mjs";
...
var middlewareSecret = "141c87a3-c7a6-489f-8b8b-157149377fd0";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/home/francisco/.nvm/versions/node/v24.15.0/bin/npm" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/home/francisco/.nvm/versions/node/v24.15.0/bin/npm" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
[
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/alumno/mi-rutina",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/alumno\\/mi-rutina\\/?$",
			"segments": [[{
				"content": "alumno",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/alumno/mi-rutina.astro",
			"pathname": "/alumno/mi-rutina",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/admin/caja",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/admin\\/caja\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/admin/caja.ts",
			"pathname": "/api/admin/caja",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/admin/clientes.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/admin\\/configuracion\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/admin/configuracion.ts",
			"pathname": "/api/admin/configuracion",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/admin/dashboard.ts",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/admin/ejercicios",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/admin\\/ejercicios\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/admin/ejercicios.ts",
			"pathname": "/api/admin/ejercicios",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/admin/planes.ts",
			"pathname": "/api/admin/planes",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/admin/profesores.ts",
			"pathname": "/api/admin/profesores",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/admin/rutinas",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/admin\\/rutinas\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/admin/rutinas.ts",
			"pathname": "/api/admin/rutinas",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"segments": [[{
				...
				"content": "admin-session",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/api/admin-session.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/login-admin.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/login-alumno\\/?$",
			"segments": [[{
				"content": "api",
				"dynamic": false,
				"spread": false
			}], [{
				"content": "login-alumno",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/api/login-alumno.ts",
			"pathname": "/api/login-alumno",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/login-profesor",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/login-profesor\\/?$",
			"segments": [[{
				"content": "api",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/api/login-profesor.ts",
			"pathname": "/api/login-profesor",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/dashboard/caja.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/dashboard/clientes.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/dashboard/configuracion.astro",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/dashboard/ejercicios",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/dashboard\\/ejercicios\\/?$",
			"segments": [[{
				"content": "dashboard",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/dashboard/ejercicios.astro",
			"pathname": "/dashboard/ejercicios",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/dashboard/planes.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/dashboard/profesores.astro",
			"pathname": "/dashboard/profesores",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/dashboard/rutinas.astro",
			"pathname": "/dashboard/rutinas",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/profesor/clientes",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/profesor\\/clientes\\/?$",
			"segments": [[{
				"content": "profesor",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/profesor/clientes.astro",
			"pathname": "/profesor/clientes",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/profesor/ejercicios",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/profesor\\/ejercicios\\/?$",
			"segments": [[{
				"content": "profesor",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/profesor/ejercicios.astro",
			"pathname": "/profesor/ejercicios",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/profesor/rutinas",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/profesor\\/rutinas\\/?$",
			"segments": [[{
				"content": "profesor",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/profesor/rutinas.astro",
			"pathname": "/profesor/rutinas",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/profesor/ver-rutina",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/profesor\\/ver-rutina\\/?$",
			"segments": [[{
				"content": "profesor",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/profesor/ver-rutina.astro",
			"pathname": "/profesor/ver-rutina",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
var _page0 = () => import("./chunks/generic_tY-BZR4L.mjs");
var _page1 = () => import("./chunks/admin_kgmwH4iu.mjs");
var _page2 = () => import("./chunks/mi-rutina_CQvDZFcD.mjs");
var _page3 = () => import("./chunks/caja_Cn3Y3n8u.mjs");
var _page4 = () => import("./chunks/clientes_DyLXR0_m.mjs");
var _page5 = () => import("./chunks/configuracion_7YCnu8pS.mjs");
var _page6 = () => import("./chunks/dashboard_B_WfMUbq.mjs");
var _page7 = () => import("./chunks/ejercicios_DmSPEerg.mjs");
var _page8 = () => import("./chunks/planes_CLdHHuM6.mjs");
var _page9 = () => import("./chunks/profesores_BkGJnp-7.mjs");
var _page10 = () => import("./chunks/rutinas_BV7_IMli.mjs");
var _page11 = () => import("./chunks/admin-session_BsvrzXjK.mjs");
var _page12 = () => import("./chunks/login-admin_BmJkpAi7.mjs");
var _page13 = () => import("./chunks/login-alumno_CPKtz_Nh.mjs");
var _page14 = () => import("./chunks/login-profesor_CvOR6VTG.mjs");
var _page15 = () => import("./chunks/logout_1Pxq9s7t.mjs");
var _page16 = () => import("./chunks/caja_DH-PGL07.mjs");
var _page17 = () => import("./chunks/clientes_B_qD9FOi.mjs");
var _page18 = () => import("./chunks/configuracion_DctjJZMT.mjs");
var _page19 = () => import("./chunks/ejercicios_BA5tr9nH.mjs");
var _page20 = () => import("./chunks/planes_CaO8CzXH.mjs");
var _page21 = () => import("./chunks/profesores_BUle2e1W.mjs");
var _page22 = () => import("./chunks/rutinas_QIjtfQtW.mjs");
var _page23 = () => import("./chunks/index_BQs2QQ3a.mjs");
var _page24 = () => import("./chunks/login_h_LZ7w0d.mjs");
var _page25 = () => import("./chunks/clientes_DLPmbWT7.mjs");
var _page26 = () => import("./chunks/ejercicios_CUqYZoGr.mjs");
var _page27 = () => import("./chunks/rutinas_D1Do6QMb.mjs");
var _page28 = () => import("./chunks/ver-rutina_DW2eyAZ7.mjs");
var _page29 = () => import("./chunks/index_Dm91Bkxn.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/admin.astro", _page1],
	["src/pages/alumno/mi-rutina.astro", _page2],
	["src/pages/api/admin/caja.ts", _page3],
	["src/pages/api/admin/clientes.ts", _page4],
	["src/pages/api/admin/configuracion.ts", _page5],
	["src/pages/api/admin/dashboard.ts", _page6],
	["src/pages/api/admin/ejercicios.ts", _page7],
	["src/pages/api/admin/planes.ts", _page8],
	["src/pages/api/admin/profesores.ts", _page9],
	["src/pages/api/admin/rutinas.ts", _page10],
	["src/pages/api/admin-session.ts", _page11],
	["src/pages/api/login-admin.ts", _page12],
	["src/pages/api/login-alumno.ts", _page13],
	["src/pages/api/login-profesor.ts", _page14],
	["src/pages/api/logout.ts", _page15],
	["src/pages/dashboard/caja.astro", _page16],
	["src/pages/dashboard/clientes.astro", _page17],
	["src/pages/dashboard/configuracion.astro", _page18],
	["src/pages/dashboard/ejercicios.astro", _page19],
	["src/pages/dashboard/planes.astro", _page20],
	["src/pages/dashboard/profesores.astro", _page21],
	["src/pages/dashboard/rutinas.astro", _page22],
	["src/pages/dashboard/index.astro", _page23],
	["src/pages/login.astro", _page24],
	["src/pages/profesor/clientes.astro", _page25],
	["src/pages/profesor/ejercicios.astro", _page26],
	["src/pages/profesor/rutinas.astro", _page27],
	["src/pages/profesor/ver-rutina.astro", _page28],
	["src/pages/index.astro", _page29]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///home/francisco/Escritorio/Proyectos/gym-saas-admin/","cacheDir":"file:///home/francisco/Escritorio/Proyectos/gym-saas-admin/node_modules/.astro/","outDir":"file:///home/francisco/Escritorio/Proyectos/gym-saas-admin/dist/","srcDir":"file:///home/francisco/Escritorio/Proyectos/gym-saas-admin/src/","publicDir":"file:///home/francisco/Escritorio/Proyectos/gym-saas-admin/public/","buildClientDir":"file:///home/francisco/Escritorio/Proyectos/gym-saas-admin/dist/client/","buildServerDir":"file:///home/francisco/Escritorio/Proyectos/gym-saas-admin/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.DXk_KHcy.css"}],"routeData":{"route":"/admin","isIndex":false,"type":"page","pattern":"^\\/admin\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin.astro","pathname":"/admin","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.DXk_KHcy.css"}],"routeData":{"route":"/alumno/mi-rutina","isIndex":false,"type":"page","pattern":"^\\/alumno\\/mi-rutina\\/?$","segments":[[{"content":"alumno","dynamic":false,"spread":false}],[{"content":"mi-rutina","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/alumno/mi-rutina.astro","pathname":"/alumno/mi-rutina","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/admin/caja","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/admin\\/caja\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"admin","dynamic":false,"spread":false}],[{"content":"caja","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/admin/caja.ts","pathname":"/api/admin/caja","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/admin/clientes","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/admin\\/clientes\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"admin","dynamic":false,"spread":false}],[{"content":"clientes","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/admin/clientes.ts","pathname":"/api/admin/clientes","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/admin/configuracion","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/admin\\/configuracion\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"admin","dynamic":false,"spread":false}],[{"content":"configuracion","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/admin/configuracion.ts","pathname":"/api/admin/configuracion","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/admin/dashboard","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/admin\\/dashboard\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"admin","dynamic":false,"spread":false}],[{"content":"dashboard","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/admin/dashboard.ts","pathname":"/api/admin/dashboard","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/admin/ejercicios","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/admin\\/ejercicios\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"admin","dynamic":false,"spread":false}],[{"content":"ejercicios","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/admin/ejercicios.ts","pathname":"/api/admin/ejercicios","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/admin/planes","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/admin\\/planes\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"admin","dynamic":false,"spread":false}],[{"content":"planes","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/admin/planes.ts","pathname":"/api/admin/planes","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/admin/profesores","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/admin\\/profesores\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"admin","dynamic":false,"spread":false}],[{"content":"profesores","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/admin/profesores.ts","pathname":"/api/admin/profesores","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/admin/rutinas","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/admin\\/rutinas\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"admin","dynamic":false,"spread":false}],[{"content":"rutinas","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/admin/rutinas.ts","pathname":"/api/admin/rutinas","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/admin-session","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/admin-session\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"admin-session","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/admin-session.ts","pathname":"/api/admin-session","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/login-admin","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/login-admin\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"login-admin","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/login-admin.ts","pathname":"/api/login-admin","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/login-alumno","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/login-alumno\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"login-alumno","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/login-alumno.ts","pathname":"/api/login-alumno","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/login-profesor","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/login-profesor\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"login-profesor","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/login-profesor.ts","pathname":"/api/login-profesor","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/logout","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/logout\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"logout","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/logout.ts","pathname":"/api/logout","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.DXk_KHcy.css"}],"routeData":{"route":"/dashboard/caja","isIndex":false,"type":"page","pattern":"^\\/dashboard\\/caja\\/?$","segments":[[{"content":"dashboard","dynamic":false,"spread":false}],[{"content":"caja","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/dashboard/caja.astro","pathname":"/dashboard/caja","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.DXk_KHcy.css"}],"routeData":{"route":"/dashboard/clientes","isIndex":false,"type":"page","pattern":"^\\/dashboard\\/clientes\\/?$","segments":[[{"content":"dashboard","dynamic":false,"spread":false}],[{"content":"clientes","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/dashboard/clientes.astro","pathname":"/dashboard/clientes","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.DXk_KHcy.css"}],"routeData":{"route":"/dashboard/configuracion","isIndex":false,"type":"page","pattern":"^\\/dashboard\\/configuracion\\/?$","segments":[[{"content":"dashboard","dynamic":false,"spread":false}],[{"content":"configuracion","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/dashboard/configuracion.astro","pathname":"/dashboard/configuracion","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.DXk_KHcy.css"}],"routeData":{"route":"/dashboard/ejercicios","isIndex":false,"type":"page","pattern":"^\\/dashboard\\/ejercicios\\/?$","segments":[[{"content":"dashboard","dynamic":false,"spread":false}],[{"content":"ejercicios","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/dashboard/ejercicios.astro","pathname":"/dashboard/ejercicios","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.DXk_KHcy.css"}],"routeData":{"route":"/dashboard/planes","isIndex":false,"type":"page","pattern":"^\\/dashboard\\/planes\\/?$","segments":[[{"content":"dashboard","dynamic":false,"spread":false}],[{"content":"planes","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/dashboard/planes.astro","pathname":"/dashboard/planes","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.DXk_KHcy.css"}],"routeData":{"route":"/dashboard/profesores","isIndex":false,"type":"page","pattern":"^\\/dashboard\\/profesores\\/?$","segments":[[{"content":"dashboard","dynamic":false,"spread":false}],[{"content":"profesores","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/dashboard/profesores.astro","pathname":"/dashboard/profesores","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.DXk_KHcy.css"}],"routeData":{"route":"/dashboard/rutinas","isIndex":false,"type":"page","pattern":"^\\/dashboard\\/rutinas\\/?$","segments":[[{"content":"dashboard","dynamic":false,"spread":false}],[{"content":"rutinas","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/dashboard/rutinas.astro","pathname":"/dashboard/rutinas","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.DXk_KHcy.css"}],"routeData":{"route":"/dashboard","isIndex":true,"type":"page","pattern":"^\\/dashboard\\/?$","segments":[[{"content":"dashboard","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/dashboard/index.astro","pathname":"/dashboard","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.DXk_KHcy.css"}],"routeData":{"route":"/login","isIndex":false,"type":"page","pattern":"^\\/login\\/?$","segments":[[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/login.astro","pathname":"/login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.DXk_KHcy.css"}],"routeData":{"route":"/profesor/clientes","isIndex":false,"type":"page","pattern":"^\\/profesor\\/clientes\\/?$","segments":[[{"content":"profesor","dynamic":false,"spread":false}],[{"content":"clientes","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/profesor/clientes.astro","pathname":"/profesor/clientes","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.DXk_KHcy.css"}],"routeData":{"route":"/profesor/ejercicios","isIndex":false,"type":"page","pattern":"^\\/profesor\\/ejercicios\\/?$","segments":[[{"content":"profesor","dynamic":false,"spread":false}],[{"content":"ejercicios","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/profesor/ejercicios.astro","pathname":"/profesor/ejercicios","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.DXk_KHcy.css"}],"routeData":{"route":"/profesor/rutinas","isIndex":false,"type":"page","pattern":"^\\/profesor\\/rutinas\\/?$","segments":[[{"content":"profesor","dynamic":false,"spread":false}],[{"content":"rutinas","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/profesor/rutinas.astro","pathname":"/profesor/rutinas","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.DXk_KHcy.css"}],"routeData":{"route":"/profesor/ver-rutina","isIndex":false,"type":"page","pattern":"^\\/profesor\\/ver-rutina\\/?$","segments":[[{"content":"profesor","dynamic":false,"spread":false}],[{"content":"ver-rutina","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/profesor/ver-rutina.astro","pathname":"/profesor/ver-rutina","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/caja.astro",{"propagation":"none","containsHead":true}],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/clientes.astro",{"propagation":"none","containsHead":true}],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/configuracion.astro",{"propagation":"none","containsHead":true}],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/ejercicios.astro",{"propagation":"none","containsHead":true}],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/index.astro",{"propagation":"none","containsHead":true}],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/planes.astro",{"propagation":"none","containsHead":true}],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/profesores.astro",{"propagation":"none","containsHead":true}],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/rutinas.astro",{"propagation":"none","containsHead":true}],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/profesor/clientes.astro",{"propagation":"none","containsHead":true}],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/profesor/ejercicios.astro",{"propagation":"none","containsHead":true}],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/profesor/rutinas.astro",{"propagation":"none","containsHead":true}],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/profesor/ver-rutina.astro",{"propagation":"none","containsHead":true}],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/admin.astro",{"propagation":"none","containsHead":true}],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/login.astro",{"propagation":"none","containsHead":true}],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/alumno/mi-rutina.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.DxzDTztq.mjs","\u0000virtual:astro:middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/api/admin-session@_@ts":"chunks/admin-session_BsvrzXjK.mjs","\u0000virtual:astro:page:src/pages/admin@_@astro":"chunks/admin_kgmwH4iu.mjs","\u0000virtual:astro:page:src/pages/api/admin/caja@_@ts":"chunks/caja_Cn3Y3n8u.mjs","\u0000virtual:astro:page:src/pages/dashboard/caja@_@astro":"chunks/caja_DH-PGL07.mjs","\u0000virtual:astro:page:src/pages/dashboard/clientes@_@astro":"chunks/clientes_B_qD9FOi.mjs","\u0000virtual:astro:page:src/pages/profesor/clientes@_@astro":"chunks/clientes_DLPmbWT7.mjs","\u0000virtual:astro:page:src/pages/api/admin/clientes@_@ts":"chunks/clientes_DyLXR0_m.mjs","\u0000virtual:astro:page:src/pages/api/admin/configuracion@_@ts":"chunks/configuracion_7YCnu8pS.mjs","\u0000virtual:astro:page:src/pages/dashboard/configuracion@_@astro":"chunks/configuracion_DctjJZMT.mjs","\u0000virtual:astro:page:src/pages/api/admin/dashboard@_@ts":"chunks/dashboard_B_WfMUbq.mjs","\u0000virtual:astro:page:src/pages/dashboard/ejercicios@_@astro":"chunks/ejercicios_BA5tr9nH.mjs","\u0000virtual:astro:page:src/pages/profesor/ejercicios@_@astro":"chunks/ejercicios_CUqYZoGr.mjs","\u0000virtual:astro:page:src/pages/api/admin/ejercicios@_@ts":"chunks/ejercicios_DmSPEerg.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_tY-BZR4L.mjs","\u0000virtual:astro:page:src/pages/dashboard/index@_@astro":"chunks/index_BQs2QQ3a.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_Dm91Bkxn.mjs","\u0000virtual:astro:page:src/pages/api/login-admin@_@ts":"chunks/login-admin_BmJkpAi7.mjs","\u0000virtual:astro:page:src/pages/api/login-alumno@_@ts":"chunks/login-alumno_CPKtz_Nh.mjs","\u0000virtual:astro:page:src/pages/api/login-profesor@_@ts":"chunks/login-profesor_CvOR6VTG.mjs","\u0000virtual:astro:page:src/pages/login@_@astro":"chunks/login_h_LZ7w0d.mjs","\u0000virtual:astro:page:src/pages/api/logout@_@ts":"chunks/logout_1Pxq9s7t.mjs","\u0000virtual:astro:page:src/pages/alumno/mi-rutina@_@astro":"chunks/mi-rutina_CQvDZFcD.mjs","\u0000virtual:astro:page:src/pages/api/admin/planes@_@ts":"chunks/planes_CLdHHuM6.mjs","\u0000virtual:astro:page:src/pages/dashboard/planes@_@astro":"chunks/planes_CaO8CzXH.mjs","\u0000virtual:astro:page:src/pages/dashboard/profesores@_@astro":"chunks/profesores_BUle2e1W.mjs","\u0000virtual:astro:page:src/pages/api/admin/profesores@_@ts":"chunks/profesores_BkGJnp-7.mjs","\u0000virtual:astro:page:src/pages/api/admin/rutinas@_@ts":"chunks/rutinas_BV7_IMli.mjs","\u0000virtual:astro:page:src/pages/profesor/rutinas@_@astro":"chunks/rutinas_D1Do6QMb.mjs","\u0000virtual:astro:page:src/pages/dashboard/rutinas@_@astro":"chunks/rutinas_QIjtfQtW.mjs","/home/francisco/Escritorio/Proyectos/gym-saas-admin/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_B35dzq0H.mjs","\u0000virtual:astro:page:src/pages/profesor/ver-rutina@_@astro":"chunks/ver-rutina_DW2eyAZ7.mjs","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/layouts/DashboardLayout.astro?astro&type=script&index=0&lang.ts":"_astro/DashboardLayout.astro_astro_type_script_index_0_lang.D0EmNGn9.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/layouts/ProfesorLayout.astro?astro&type=script&index=0&lang.ts":"_astro/ProfesorLayout.astro_astro_type_script_index_0_lang.C9p5Q6vo.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/admin.astro?astro&type=script&index=0&lang.ts":"_astro/admin.astro_astro_type_script_index_0_lang.8jINdf68.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/caja.astro?astro&type=script&index=0&lang.ts":"_astro/caja.astro_astro_type_script_index_0_lang.C_dmZCbu.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/clientes.astro?astro&type=script&index=0&lang.ts":"_astro/clientes.astro_astro_type_script_index_0_lang.AXrwutlH.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/profesor/clientes.astro?astro&type=script&index=0&lang.ts":"_astro/clientes.astro_astro_type_script_index_0_lang.CTmP_wq0.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/configuracion.astro?astro&type=script&index=0&lang.ts":"_astro/configuracion.astro_astro_type_script_index_0_lang.ClVb4lG-.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/ejercicios.astro?astro&type=script&index=0&lang.ts":"_astro/ejercicios.astro_astro_type_script_index_0_lang.C1QPLTz5.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/profesor/ejercicios.astro?astro&type=script&index=0&lang.ts":"_astro/ejercicios.astro_astro_type_script_index_0_lang.CsjsvLoH.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.CIN3mo5k.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/login.astro?astro&type=script&index=0&lang.ts":"_astro/login.astro_astro_type_script_index_0_lang.DxoqVBpS.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/alumno/mi-rutina.astro?astro&type=script&index=0&lang.ts":"_astro/mi-rutina.astro_astro_type_script_index_0_lang.Cd9vKmxa.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/planes.astro?astro&type=script&index=0&lang.ts":"_astro/planes.astro_astro_type_script_index_0_lang.F9ONhtia.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/profesores.astro?astro&type=script&index=0&lang.ts":"_astro/profesores.astro_astro_type_script_index_0_lang.M_XicKG7.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/profesor/rutinas.astro?astro&type=script&index=0&lang.ts":"_astro/rutinas.astro_astro_type_script_index_0_lang.CVusYIwa.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/rutinas.astro?astro&type=script&index=0&lang.ts":"_astro/rutinas.astro_astro_type_script_index_0_lang.mSfFqjhN.js","/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/profesor/ver-rutina.astro?astro&type=script&index=0&lang.ts":"_astro/ver-rutina.astro_astro_type_script_index_0_lang.Dc9uRJZj.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/layouts/ProfesorLayout.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`sidebar-toggle`),t=document.getElementById(`sidebar`),n=document.getElementById(`sidebar-overlay`);function r(){t?.classList.remove(`-translate-x-full`),n?.classList.remove(`hidden`),e?.setAttribute(`aria-expanded`,`true`)}function i(){t?.classList.add(`-translate-x-full`),n?.classList.add(`hidden`),e?.setAttribute(`aria-expanded`,`false`)}e?.addEventListener(`click`,()=>{e.getAttribute(`aria-expanded`)===`true`?i():r()}),n?.addEventListener(`click`,i),window.matchMedia(`(min-width: 1024px)`).addEventListener(`change`,e=>{e.matches&&i()}),document.getElementById(`btn-cerrar-sesion`)?.addEventListener(`click`,async()=>{localStorage.clear();try{await fetch(`/api/logout`,{method:`POST`})}catch{}window.location.href=`/login`});"],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/dashboard/configuracion.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`config-cargando`),t=document.getElementById(`config-error`),n=document.getElementById(`config-error-mensaje`),r=document.getElementById(`config-formulario`),i=document.getElementById(`form-config`),a=document.getElementById(`btn-guardar-config`),o=document.getElementById(`config-exito`),s=document.getElementById(`form-config-error`),c=document.getElementById(`cfg-nombre`),l=document.getElementById(`cfg-direccion`),u=document.getElementById(`cfg-telefono`),d=document.getElementById(`cfg-email`);function f(e){n&&(n.textContent=e),t?.classList.remove(`hidden`),t?.classList.add(`flex`)}async function p(){t?.classList.add(`hidden`),t?.classList.remove(`flex`),e&&(e.hidden=!1),r?.classList.add(`hidden`);let n=await fetch(`/api/admin/configuracion`),i=await n.json();if(e&&(e.hidden=!0),!n.ok||i.error){f(`No se pudo cargar la configuración: ${i.error??`Error desconocido`}`);return}i.config&&(c&&(c.value=i.config.nombre??``),l&&(l.value=i.config.direccion??``),u&&(u.value=i.config.telefono??``),d&&(d.value=i.config.email??``)),r?.classList.remove(`hidden`)}i?.addEventListener(`submit`,async e=>{if(e.preventDefault(),!i||!a)return;o?.classList.add(`hidden`),s?.classList.add(`hidden`);let t=new FormData(i),n=t.get(`nombre`)?.trim(),r=t.get(`direccion`)?.trim()||null,c=t.get(`telefono`)?.trim()||null,l=t.get(`email`)?.trim()||null;if(!n){s&&(s.textContent=`El nombre del gimnasio es requerido.`,s.classList.remove(`hidden`));return}a.disabled=!0,a.textContent=`Guardando…`;let u=await fetch(`/api/admin/configuracion`,{method:`PUT`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify({nombre:n,direccion:r,telefono:c,email:l})}),d=await u.json();if(a.disabled=!1,a.textContent=`Guardar Cambios`,!u.ok||d.error){s&&(s.textContent=`Error: ${d.error??`Error desconocido`}`,s.classList.remove(`hidden`));return}o?.classList.remove(`hidden`),setTimeout(()=>o?.classList.add(`hidden`),3e3)}),p();"],["/home/francisco/Escritorio/Proyectos/gym-saas-admin/src/pages/login.astro?astro&type=script&index=0&lang.ts","var e=`alumno`,t=document.getElementById(`form-profesor`),n=document.getElementById(`form-alumno`),r=document.getElementById(`btn-profesor`),i=document.getElementById(`btn-alumno`),a=document.getElementById(`error-profesor`),o=document.getElementById(`error-alumno`);function s(e,t){e&&(e.textContent=t,e.classList.remove(`hidden`))}function c(e){e?.classList.add(`hidden`)}function l(e,t){e&&(e.disabled=t,e.textContent=t?`Ingresando…`:`Ingresar`)}document.querySelectorAll(`[data-rol]`).forEach(r=>{r.addEventListener(`click`,()=>{e=r.dataset.rol,document.querySelectorAll(`[data-rol]`).forEach(t=>{let n=t.dataset.rol===e;t.classList.toggle(`bg-white`,n),t.classList.toggle(`text-zinc-900`,n),t.classList.toggle(`shadow-sm`,n),t.classList.toggle(`text-zinc-500`,!n)}),t?.classList.toggle(`hidden`,e!==`profesor`),n?.classList.toggle(`hidden`,e!==`alumno`),c(a),c(o)})}),r?.addEventListener(`click`,async()=>{c(a);let e=document.getElementById(`profesor-dni`)?.value.trim(),t=document.getElementById(`profesor-password`)?.value;if(!e){s(a,`Ingresá tu DNI.`);return}if(!t){s(a,`Ingresá la contraseña.`);return}l(r,!0);let n=await fetch(`/api/login-profesor`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify({dni:e,password:t})});if(l(r,!1),!n.ok){s(a,(await n.json()).error||`Error al validar. Intentá de nuevo.`);return}let{id:i}=await n.json();localStorage.setItem(`profesor_id`,i),window.location.href=`/profesor/clientes`}),document.getElementById(`alumno-dni`)?.addEventListener(`keydown`,e=>{e.key===`Enter`&&i?.click()}),document.getElementById(`profesor-dni`)?.addEventListener(`keydown`,e=>{e.key===`Enter`&&r?.click()}),document.getElementById(`profesor-password`)?.addEventListener(`keydown`,e=>{e.key===`Enter`&&r?.click()}),i?.addEventListener(`click`,async()=>{c(o);let e=document.getElementById(`alumno-dni`)?.value.trim();if(!e){s(o,`Ingresá tu DNI.`);return}l(i,!0);let t=await fetch(`/api/login-alumno`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify({dni:e})});if(l(i,!1),!t.ok){s(o,(await t.json()).error||`Error al buscar. Intentá de nuevo.`);return}let{id:n}=await t.json();localStorage.setItem(`alumno_id`,n),window.location.href=`/alumno/mi-rutina`});"]],"assets":["/favicon.ico","/favicon.svg","/_astro/DashboardLayout.astro_astro_type_script_index_0_lang.D0EmNGn9.js","/_astro/admin.astro_astro_type_script_index_0_lang.8jINdf68.js","/_astro/caja.astro_astro_type_script_index_0_lang.C_dmZCbu.js","/_astro/clientes.astro_astro_type_script_index_0_lang.AXrwutlH.js","/_astro/clientes.astro_astro_type_script_index_0_lang.CTmP_wq0.js","/_astro/ejercicios.astro_astro_type_script_index_0_lang.C1QPLTz5.js","/_astro/ejercicios.astro_astro_type_script_index_0_lang.CsjsvLoH.js","/_astro/index.astro_astro_type_script_index_0_lang.CIN3mo5k.js","/_astro/mi-rutina.astro_astro_type_script_index_0_lang.Cd9vKmxa.js","/_astro/paginacion.DSEKGppP.js","/_astro/planes.astro_astro_type_script_index_0_lang.F9ONhtia.js","/_astro/profesores.astro_astro_type_script_index_0_lang.M_XicKG7.js","/_astro/rutinas.astro_astro_type_script_index_0_lang.CVusYIwa.js","/_astro/rutinas.astro_astro_type_script_index_0_lang.mSfFqjhN.js","/_astro/supabase.9U4HlvOh.js","/_astro/ver-rutina.astro_astro_type_script_index_0_lang.Dc9uRJZj.js","/_astro/global.DXk_KHcy.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"/lxnLTWDKU8XWgNnJCWqF/pvmuXJvWOlmsfDK8CdUpY=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
